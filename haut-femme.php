...
$requete = "SELECT * FROM `articles` WHERE id_categorie = 1 AND id_type = 1 ORDER BY date DESC";
$query = mysqli_query($connexion, $requete);
$resultat = mysqli_fetch_all($query);

$requete1 = "SELECT * FROM `articles` WHERE id_categorie = 1 AND id_type = 1 ORDER BY prix ASC";
$query1 = mysqli_query($connexion, $requete1);
$resultat1 = mysqli_fetch_all($query1);

$requete2 = "SELECT * FROM `articles` WHERE id_categorie = 1 AND id_type = 1 ORDER BY prix DESC";
