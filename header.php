		...
		<ul class="ul">
				...
				?>			
						...
						<?php foreach($res_cat as $categories):
							...
							<li class="li">
								<a href="produits.php?cat=<?php echo $idcat ?>" class="header-link"><?php echo $namecat ?></a>
							...
							?>
								...
								<?php foreach($res_typ as $types):
									$idtype = $types[0];
									$nametype = $types[1]; ?>
									<li class="li"><a href="produits.php?cat=<?php echo $idcat ?>&type=<?php echo $idtype ?>" class="header-link"><?php echo $nametype ?></a></li>
								<?php endforeach; ?> 
								</ul>
							</li>		  
						<?php endforeach; ?>
